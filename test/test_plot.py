"""Tests for plot axis humanization features and CLI integration."""
...
def test_matplotlib_plot_sanity(mock_plot_save: MagicMock) -> None:
...
@patch("matplotlib.pyplot.savefig")
def test_matplotlib_plot_file_not_found(mock_plot_save: MagicMock) -> None:
    args = argparse.Namespace(
        command="plot",
...
def test_matplotlib_plot_invalid_json(
    _mock_open: MagicMock, mock_plot_save: MagicMock
) -> None:
    args = argparse.Namespace(
        command="plot",
        file_path="test/data/mriqc-example/usage.json",
...
@patch("matplotlib.pyplot.savefig")
def test_matplotlib_plot_info_json(mock_plot_save: MagicMock) -> None:
...
def test_matplotlib_plot_info_json_absolute_path(
    mock_plot_save: MagicMock, monkeypatch: Any, tmp_path: Any
) -> None:
...
@patch("matplotlib.pyplot.savefig")
@patch("builtins.open", new_callable=mock_open, read_data='{"missing": "timestamp"}')
...
@patch("builtins.__import__", side_effect=ImportError("No module named 'matplotlib'"))
def test_matplotlib_plot_missing_dependency(_mock_import: MagicMock) -> None:
