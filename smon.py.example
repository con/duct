#!/usr/bin/env python3
# Based on https://raw.githubusercontent.com/brainlife/abcd-spec/master/hooks/smon  # noqa
...
with open(name, "w") as outfile:
    ...
    # figure out max PPN
    max_ppn = os.sysconf('SC_NPROCESSORS_CONF')  # default to all available cores  # noqa
    ...
    if "PBS_JOBID" in os.environ:
        # PBS doesn't expose requested memory in ENV.. I need to query from qstat # noqa
